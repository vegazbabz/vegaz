This policy will configure (DeployIfNotExists-effect) if storage accounts does not have container soft delete enabled. Minimum value is 1 day, maximum is 365 days.
